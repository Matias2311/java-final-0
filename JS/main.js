...
$(document).ready(function () {
    // Cargar información de productos desde el archivo JSON local utilizando Fetch
...
// Función para cargar información de productos desde un archivo JSON local utilizando Fetch y Promesas
function cargarProductosDesdeJSON() {
    fetch('productos.json')
        ...
        .then(data => {
            baseDeDatos = data;
            // Renderizar productos después de cargar la información
            renderizarProductos();
        })
        .catch(error => {
